import  currentLocation from "./currentLocation.js";
 ...
 export const setPlaceHolderText = () => {
    ...
    ? (input.placeholder = "City, State, Coutry")
...
export const displayError = (headerMsg, srMsg) => {
    updateWeatherLocatonHeader(headerMsg);
...
export const displayApiError = (statusCode) => {
    ...
    updateWeatherLocatonHeader(properMsg);
...
export  const updateDisplay = (weatherJson, locationObj) => {
    ...
    updateWeatherLocatonHeader(locationObj.getName());
...
const buildScreenReaderWeather = (weatherJson, locationObj) => {
    ...
    return `${weatherJson.current.weather[0].description} and ${Math.round(Number(weatherJson.current.weather.temp))}˚${tempUnit} in ${location}`
}
...
const createDailyForecastDivs = (dayweather) => {
    const dayAbbreTxt = getDayAbbreviation(dayweather.dt);
    const dayAbbre = createElem("p", "dayAbbre", dayAbbreTxt);
    ...
    return [dayAbbre, dayIcon, dayHigh, dayLow];
}
